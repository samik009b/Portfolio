  ...
  return (
    <div className="border-2 border-double border-brand/60 bg-neutral-primary-soft p-6 relative font-mono text-sm">
      ...
      <div className="flex items-center justify-between border-b border-default border-dashed pb-3 mb-5">
        ...
        <span className="text-xs text-neutral-tertiary-medium">READ_ONLY</span>
      </div>

      <div className="space-y-6">
        {/* Monospace Bio Text */}
        <p className="text-xs sm:text-sm text-body leading-relaxed max-w-4xl pl-4 border-l-2 border-brand/80 mt-2">
          I am Samik Biswas, a dedicated web engineer and cloud computing
          enthusiast. My developer philosophy centers on software craftsmanship,
          simplicity, and absolute system resilience, utilizing React and Vite
          on the frontend and containerized Node.js REST APIs in AWS/Docker
          environments on the backend.
        </p>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div className="border border-default bg-neutral-primary p-4 rounded-sm hover:border-brand-strong hover:-translate-y-1 hover:scale-[1.02] hover:shadow-brand/5 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] shadow-sm cursor-pointer active:scale-[0.98]">
              <div className="text-brand font-bold text-[10px] tracking-widest">
                [ DEGREE: HIGHER SECONDARY ]
              </div>
              <div className="text-heading font-bold mt-1 text-xs sm:text-sm">
                PHYSICS, CHEM, MATH, BIO
              </div>
              <div className="text-neutral-tertiary-medium text-[9px] mt-1.5 uppercase tracking-wide">
                RAMAKRISHNA MISSION BOYS' HOME, RAHARA // COMPLETED 2024
              </div>
            </div>

            <div className="border border-default bg-neutral-primary p-4 rounded-sm hover:border-brand-strong hover:-translate-y-1 hover:scale-[1.02] hover:shadow-brand/5 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] shadow-sm cursor-pointer active:scale-[0.98]">
              <div className="text-brand font-bold text-[10px] tracking-widest">
                [ DEGREE: BACHELOR_OF_TECHNOLOGY ]
              </div>
              <div className="text-heading font-bold mt-1 text-xs sm:text-sm">
                INFORMATION TECHNOLOGY
              </div>
              <div className="text-neutral-tertiary-medium text-[9px] mt-1.5 uppercase tracking-wide">
                NETAJI SUBHASH ENGINEERING COLLEGE, GARIA // EXPECTED 2028
              </div>
            </div>
